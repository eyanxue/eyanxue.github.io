          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/muscles/" -%}{%- assign url = "/muscles/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/muscles/" -%}{%- assign url = "/muscles/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
  ...
  {%- if site.socials_in_search -%}
    {%- for social in site.data.socials -%}
      {%- case social[0] -%}
        ...
        {%- when "musclesger_url" -%}
          {%- assign social_id = "social-musclesger" -%}
          {%- assign social_title = "musclesger" -%}
